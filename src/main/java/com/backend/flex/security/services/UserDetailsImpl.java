package com.backend.flex.security.services;
...
public class UserDetailsImpl implements UserDetails {
    ...
    public void validateAccess(Website website){
        if (this.getAuthorities().stream()
                .anyMatch(a -> a.getAuthority().equals("ROLE_USER")) && website.getUser().getId() != this.getId()) {
